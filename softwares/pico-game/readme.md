...
<img src="./readme-pictures/BitDogLab-PicoGame.png" width=60% height=60%>
...
<img src="./readme-pictures/pico-games-screen.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-connect-pipico.png" width=60% height=60%>

Em seguida clique no botão STOP para parar a execução do código atual e reiniciar o backend como ilustrado abaixo.

<img src="./readme-pictures/thonny-stop-restart-backend.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-stopped.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-new-dir1.png" width=60% height=60%>

Insira o nome do diretório (exemplo "DinoGame"), e clique em "OK" como ilustrado abaixo.

<img src="./readme-pictures/thonny-new-dir2.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-saveas.png" width=60% height=60%>

Selecione para savar na sua Pi Pico como ilustrado abaixo.

<img src="./readme-pictures/thonny-save-pipico1.png" width=60% height=60%>

Em seguida seleciona a pasta alvo a ser salvo o arquivo (pasta DinoGame), como ilustrado abaixo.

<img src="./readme-pictures/thonny-save-pipico2.png" width=60% height=60%>

Digite o nome do arquivo a ser salvo na pasta (Bird.py) como ilustrado abaixo.

<img src="./readme-pictures/thonny-save-pipico3.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-save-pipico4.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-save-pipico5.png" width=60% height=60%>
...
<img src="./readme-pictures/thonny-save-pipico6.png" width=60% height=60%>
...
https://www.youtube.com/watch?v=d3d3uuJCRDc